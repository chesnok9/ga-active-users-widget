...
import '../../scss/GAActiveUsersWidget/GAActiveUsersWidget.scss';
...
const columns = [
  ...
  {type: 'number', label: 'DAU',},
  {type: 'number', label: 'WAU',},
  {type: 'number', label: 'MAU',},
]

definejs('GAActiveUsersWidget', function create (){

    return {
        createComponent: function (React, Component) {
            return class GAActiveUsersWidget extends Component {
              ...
              loadAnalytics = () => {
                ...
                const metrics = ['1dayUsers', '7dayUsers', '30dayUsers']
